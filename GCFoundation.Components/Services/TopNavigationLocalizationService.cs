...
{
    /// <summary>
    /// A service that provides localized values for top navigation keys.
    /// This service uses <see cref="IStringLocalizer{T}"/> to retrieve localized strings for the top navigation menu.
    /// </summary>
    ...
    public class TopNavigationLocalizationService<T> : ITopNavigationLocalizationService
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TopNavigationLocalizationService{T}"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Retrieves the localized value for the given top navigation key.
        /// </summary>
